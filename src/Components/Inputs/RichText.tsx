...
const RichText: React.FC<{ id?: string, className?: string, name?: string, value?: string, visible?: boolean, onChange: Function }> = ({ value = undefined, onChange = undefined, id = "editor", name = "editor", className = "" }) => {  
