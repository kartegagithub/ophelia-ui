...
const ExcelIcon: React.FC<IconProps> = ({
  ...
  const vbMaxDim = (() => {
    const p = "0 0 256 256".trim().split(/[\s,]+/).map(Number);
  ...
  return (
    ...
    >
      ...
      {isDuotone && secondaryColor && (
        <defs>
          <linearGradient id="duotone-ExcelIcon" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor={color || 'currentColor'} />
            <stop offset="100%" stopColor={secondaryColor} />
          </linearGradient>
        </defs>
      )}
      <g fill={isDuotone ? `url(#duotone-ExcelIcon)` : undefined}>
