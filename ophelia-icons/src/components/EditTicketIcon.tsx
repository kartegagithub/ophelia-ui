...
const EditTicketIcon: React.FC<IconProps> = ({
  // Boyut
  size = 24,
  width,
  height,
  ...
  const vbMaxDim = (() => {
    const p = "0 0 16 20".trim().split(/[\s,]+/).map(Number);
