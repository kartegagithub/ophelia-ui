...
const AttentionCircleIcon: React.FC<IconProps> = ({
  // Boyut
  size = 24,
  width,
  height,
  ...
  const vbMaxDim = (() => {
    const p = "0 0 89 89".trim().split(/[\s,]+/).map(Number);
