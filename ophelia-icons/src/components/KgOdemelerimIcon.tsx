...
const KgOdemelerimIcon: React.FC<IconProps> = ({
  // Boyut
  size = 24,
  width,
  height,
  ...
  return (
    ...
    >
      ...
      {isDuotone && secondaryColor && (
        <defs>
          <linearGradient id="duotone-KgOdemelerimIcon" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor={color || 'currentColor'} />
            <stop offset="100%" stopColor={secondaryColor} />
          </linearGradient>
        </defs>
      )}
      <g fill={isDuotone ? `url(#duotone-KgOdemelerimIcon)` : undefined}>
...
export default KgOdemelerimIcon;
