...
const CongratEffectedIcon: React.FC<IconProps> = ({
  // Boyut
  size = 24,
  width,
  height,
  ...
  const vbMaxDim = (() => {
    const p = "0 0 142 142".trim().split(/[\s,]+/).map(Number);
