...
const SkyBlueTicketIcon: React.FC<IconProps> = ({
  // Boyut
  size = 24,
  width,
  height,
  ...
  const vbMaxDim = (() => {
    const p = "0 0 82 72".trim().split(/[\s,]+/).map(Number);
  ...
  return (
    ...
    >
      ...
      {isDuotone && secondaryColor && (
        <defs>
          <linearGradient id="duotone-SkyBlueTicketIcon" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor={color || 'currentColor'} />
            <stop offset="100%" stopColor={secondaryColor} />
          </linearGradient>
        </defs>
      )}
      <g fill={isDuotone ? `url(#duotone-SkyBlueTicketIcon)` : undefined}>
...
export default SkyBlueTicketIcon;
